...
<div id="fullpage">
	<div class="section">
		...
		<div class="index">
    		...
    		來有ㄒㄧㄠ\聚樂部就對了!</div>
    		        <div class="share">
    		            <a title="分享超KOH時刻，就有機會獲得泰國雙人假期" >分享超KOH時刻，就有機會獲得泰國雙人假期</a>
    		        </div>
		        </div>     
		<!--
		    ...
		    <div class="content">
		        ...
		        <div class="arrow_btn">
		        	<div class="product">
			            <ul>
			                <li class="product01">
                		        <div class="tip" style="top: 75px;right: 0px;">
                		            <div class="tip_koh">
                		                部長 - KOH寶：有用不完的活力，總是充滿體力最喜歡將歡ㄒㄧㄠ\散佈給大家
                		            </div>
                		        </div> <span>KOH COCONUT酷椰子純椰子汁</span>
		        			</li>
			                <li class="product02" style="display:none;"><span>香椰脆片-原味</span></li>
			                <li class="product03" style="display:none;"><span>香椰脆片-哇沙米</span></li>
			                <li class="product04" style="display:none;"><span>香椰脆片-巧克力</span></li>
			            </ul>
		            </div>
		            <div class="lr_btn">
